...
epicsShareExtern void (*pvar_func_dlloadRegistar)(void);
...
{
    const char *bldTop = "/home/rory/Desktop/epics/base-3.14.12.5";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"softIoc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
